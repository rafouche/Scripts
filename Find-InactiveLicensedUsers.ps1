...
function Initialize-M365Auth {
    ...
    try {
        ...
        foreach ($p in $graphPermNames) {
            ...
            else { AL "Graph app role not found: $p" "WARN" }
        }
        ...
        try {
            ...
            $null = New-MgDirectoryRoleMemberByRef -DirectoryRoleId $exoAdmRole.Id -BodyParameter @{
        ...
        AL " Wait 5-10 minutes before first use, and confirm Azure AD Premium P1/P2" "WARN"
        AL " is licensed in this tenant - otherwise signInActivity reads back empty." "WARN"
        AL "============================================" "OK"
        return $true
    } catch {
